...
func (f *fakeRepository) UpdateItem(resource *persistence.Resource, oldResource *persistence.Resource) error {
	return nil
}
...
func (f *fakeErroringRepository) UpdateItem(resource *persistence.Resource, oldResource *persistence.Resource) error {
	return errors.New("broken")
}
