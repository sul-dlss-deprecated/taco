...
func (o *GetProcessStatusURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("ID is required on GetProcessStatusURL")
	}
...
func (o *GetProcessStatusURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetProcessStatusURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetProcessStatusURL")
	}
