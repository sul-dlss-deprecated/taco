...
func (o *RetrieveResourceURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("ID is required on RetrieveResourceURL")
	}
...
func (o *RetrieveResourceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on RetrieveResourceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on RetrieveResourceURL")
	}
