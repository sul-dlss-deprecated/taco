...
PROJ_TACO_SECRET_KEY   =s00s00perSekret
PROJ_ENV_VARS          =TACO_SECRET_KEY=${PROJ_TACO_SECRET_KEY} AWS_REGION=${PROJ_AWS_REGION} AWS_ACCESS_KEY_ID=${PROJ_AWS_ACCESS_KEY_ID} AWS_SECRET_ACCESS_KEY=${PROJ_AWS_SECRET_KEY}
